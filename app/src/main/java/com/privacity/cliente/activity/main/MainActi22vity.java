...
import com.privacity.cliente.activity.registration.RegistrationActivity;
...
public class MainActi22vity extends AppCompatActivity {
...
/*            Intent i = new Intent(MainActivity.this, MainActivity.class);
        ...
        if (SingletonSessionClosing.getInstance().isCloseApp()){
            ...
            ProgressBarUtil.hide(MainActi22vity.this, progressBar);
...
//        }
        ...
        ServerConfRest.getTime(this,null,null);
    }
...
//        SingletonServer.getInstance().setDeveloperMode(SharedPreferencesUtil.getDeveloperMode(this));
    ...
    public void onBackPressed() {
        ...
        if (noValidate){
            ...
            Intent i = new Intent(this, MainActi22vity.class);
            startActivity(i);
        }else{
    ...
    private void initMainView() {
        ...
        login = GetButtonReady.get(this, R.id.lock_ingresar, "Log In", new ViewCallbackActionInterface() {
            @Override
            public void action(View v) {
                try {
                    MainActi22vity.this.callLoginRest(username.getText().toString(), password.getText().toString());
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
...
// Check whether the runtime version is at least Android 5.0.
        ...
        ((com.google.android.material.floatingactionbutton.FloatingActionButton)findViewById(R.id.develop_lock)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(MainActi22vity.this,SingletonServer.getInstance().getEnvironment().name(),Toast. LENGTH_SHORT).show();
    ...
    private void setListenerRegistrarse(View v){
        v.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                IntentUtil.callActivity(RegistrationActivity.class);
        ...
        if (!SingletonValues.getInstance().isLogout()){
            ...
            if ( userP != null & passwordP != null) {
                ...
                try {
                    ...
                    mainActivityNoPass = new MainActivityNoPass(MainActi22vity.this);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem itemMenu) {
        ...
        if ( itemMenu.getItemId() == R.id.main_menu_configuracion){
            Intent i = new Intent(MainActi22vity.this, MainConfiguracionActivity.class);
            startActivity(i);
        }
        return true;
    }
    public void setLocale(String idioma) {
        ...
        Intent refresh = new Intent(this, MainActi22vity.class);
