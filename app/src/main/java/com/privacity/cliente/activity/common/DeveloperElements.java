...
public class DeveloperElements {
    ...
    private static void setListener(MainActi22vity activity, Button button, SecureFieldAndEye username, SecureFieldAndEye password, int visibility) {
        ...
        public static void developerLogin(MainActi22vity activity, SecureFieldAndEye username, SecureFieldAndEye password) {
