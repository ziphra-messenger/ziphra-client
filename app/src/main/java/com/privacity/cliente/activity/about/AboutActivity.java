...
public class AboutActivity extends CustomAppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        {
            ...
            String text = UtilsStringSingleton.getInstance().gsonPretty().toJson( SingletonServerConfiguration.getInstance().getSystemGralConf());
            tv.setText(text);

            tv.setMovementMethod(ScrollingMovementMethod.getInstance());
            //txt.setScrollBarStyle(0x03000000);
            tv.setHorizontallyScrolling(true);
            tv.setNestedScrollingEnabled(true);
