...
public class CallRestLogin {
    private static void showErrorSinInternet(MainActi22vity activity) {
    ...
    public static void callLoginRest (MainActi22vity activity, String user, String password) throws Exception {
    ...
    @NotNull
    public static AsyncCaller LoginRest(MainActi22vity activity, String user, String password) {
    ...
    public static void checkServerRunning(MainActi22vity activity, String user, String password) throws Exception {
...
//        }
//    }
    public static void callLoginRestInnerCallBack(MainActi22vity activity, String user, String password) throws Exception {
...
//  /      }
    ...
    public static CallbackRest loginCallbackRest(MainActi22vity activity, String user, String password) {
