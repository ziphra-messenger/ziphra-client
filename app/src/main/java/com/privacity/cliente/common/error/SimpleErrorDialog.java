...
public class SimpleErrorDialog {
    ...
    public static void messageDelete(MessageActivity activity){
        ...
        final View customLayout = activity.getLayoutInflater().inflate(R.layout.alertcustom, null);
        builder.setView(customLayout);
        builder.setPositiveButton(activity.getString(R.string.message_activity__message_actions__delete__for_all_and_resend), new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
        ...
        builder.setNegativeButton(activity.getString(R.string.message_activity__message_actions__delete__for_all), new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
        ...
        builder.setNeutralButton(activity.getString(R.string.message_activity__message_actions__delete__for_me), new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                RestCalls.deleteForRest(activity, DeleteForEnum.FOR_ME);
                activity.getMessageCustomActionBar().setOnActionBarMain();
            }
        });
        String titulo=activity.getString(R.string.message_activity__message_actions__delete__title);
