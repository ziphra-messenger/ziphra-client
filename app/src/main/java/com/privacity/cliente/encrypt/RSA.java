...
//	private Key privateKey;
	...
	public KeyPair generateKeyPair() throws NoSuchAlgorithmException, NoSuchProviderException {
		...
		pairgen.initialize(
				SingletonValues.getInstance().getSystemGralConf().getAsymEncrypt().getBits(),
				random);
...
//	}
	...
	public static void main(String...strings ) throws Exception {
		...
		String privateGson = GsonFormated.get().toJson(keyPair.getPrivate().getEncoded());
		String publicGson = GsonFormated.get().toJson(keyPair.getPublic().getEncoded());
		System.out.println(GsonFormated.get().toJson(keyPair.getPrivate().getEncoded()));
