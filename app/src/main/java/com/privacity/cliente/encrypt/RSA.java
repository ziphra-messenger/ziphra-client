...
public class RSA {
	public static final String CONSTANT_RSA = "RSA";
	public static final String CONSTANT_BC = "BC";
	public static final String CONSTANT_AES = "AES";

//	private KeyPair keyPair;
//	private Key publicKey;
//	private Key privateKey;

	//@Value("${privacity.security.rsa_key.bits.size}")
	/**
	...
	public KeyPair generateKeyPair() throws NoSuchAlgorithmException, NoSuchProviderException {
		KeyPairGenerator pairgen = KeyPairGenerator.getInstance(CONSTANT_RSA);
		SecureRandom random = new SecureRandom();
		pairgen.initialize(
				SingletonServerConfiguration.getInstance().getSystemGralConf().getAsymEncrypt().getBits(),
				random);
	...
	public byte[] wrapKey(Key key, PrivateKey privateKey) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, IllegalBlockSizeException, NoSuchProviderException {
		Cipher cipher = Cipher.getInstance(CONSTANT_RSA);
	...
	public Key unwrapKey(byte[] wrapedKeyBytes, PublicKey publicKey) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, NoSuchProviderException {
		...
		Key key = cipher.unwrap(wrapedKeyBytes, CONSTANT_AES, Cipher.SECRET_KEY);
		return key;
	}
//
...
//	}
	...
	public byte[] encryptFile(byte[] input, PrivateKey key)
		...
		Cipher cipher;
		cipher = Cipher.getInstance(CONSTANT_RSA);
...
//
//		String privateGson = UtilsStringSingleton.getInstance().gsonToSend(keyPair.getPrivate().getEncoded());
//		String publicGson = UtilsStringSingleton.getInstance().gsonToSend(keyPair.getPublic().getEncoded());
//		System.out.println(UtilsStringSingleton.getInstance().gsonToSend(keyPair.getPrivate().getEncoded()));
//		System.out.println(UtilsStringSingleton.getInstance().gsonToSend(keyPair.getPublic().getEncoded()));
//
//		System.out.println(keyPair.getPublic());
//
//		KeyFactory kf = KeyFactory.getInstance(CONSTANT_RSA, CONSTANT_BC);
...
//				UtilsStringSingleton.getInstance().gson().fromJson(
...
//		// privada
//
//		KeyFactory kf3 = KeyFactory.getInstance(CONSTANT_RSA, CONSTANT_BC);
